...
**A · deep_research** — query = `[topic 中文] + [scenario] + "评估框架 最佳实践 制造业 AI" + 英文`。权威：McKinsey / BCG / WEF / INCIT AIMRI / ISO 25012 / DAMA-DMBOK / NIST AI RMF / AIAG MSA / Deloitte。
**B · 合成 3-5 条洞察**。
...
```
research_query: "strategic value business case McKinsey CEO elevator test BCG AI at Scale sponsorship commitment ROI stress test manufacturing AI 战略价值 业务损失量化 领导承诺 投资回报"
...
```
research_query: "manufacturing AI data readiness ISO 25012 DAMA DMBOK NIST AI RMF sample size labeling traceability X-Y causality drift governance MLOps 数据准备度 样本量 标注 血缘"
...
```
research_query: "industrial IoT IT OT convergence OPC-UA MQTT Purdue model edge cloud network isolation AI deployment manufacturing system inventory MES SCADA PLC ERP 技术互联 系统清单 数据接口"
...
```
research_query: "process controllability AIAG MSA GR&R Cpk SPC FMEA X to Y causality physical mechanism Six Sigma DMAIC manufacturing process capability 工艺可控度 关键参数 测量系统"
...
```
research_query: "McKinsey T-shape talent WEF Lighthouse digital talent industrial AI team capability data science engineer manufacturing cross-functional collaboration 组织能力 T 型人才 AI 技能缺口"
...
```
research_query: "change management Kotter ADKAR manufacturing AI adoption resistance governance sponsorship McKinsey 70 percent failure organizational 变革管理 AI 采纳 阻力"

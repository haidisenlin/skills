...
按差异参数中给定的 `research_query` 执行一次 deep_research。query 构造规则：

```
[topic 中文核心词] + [scenario 关键词]
+ "评估框架 最佳实践 模板 制造业 工厂 AI"
+ 英文补充：[topic 英文关键词] + "assessment framework best practice checklist manufacturing"
```

权威来源优先：McKinsey、BCG、WEF Lighthouse、INCIT AIMRI、ISO 13053 / 55001、AIAG-VDA FMEA、Fraunhofer、工业互联网产业联盟（AII）。
...
```
research_query: "工厂 AI 改善场景类型分类 改善领域矩阵 痛点量化模板 制造业 AI use case taxonomy industrial pain point quantification"
...
```
research_query: "制造业 AI 项目战略价值度评估 业务损失量化 投资回报率 ROI 模型 McKinsey BCG strategic value AI business case manufacturing"
...
```
research_query: "manufacturing AI data readiness assessment sample size data quality labeling traceability CRISP-DM MLOps 工厂 AI 数据准备度 样本量 标注规范 数据血缘"
...
```
research_query: "工厂 IT OT 融合 系统互联 AI 部署 边缘计算 MES ERP SCADA 数据接口 Purdue 模型 industrial IT OT convergence AI deployment edge cloud network architecture"
...
```
research_query: "manufacturing process control capability SPC MSA process capability Cpk 测量系统分析 工艺参数 关键控制点 可控度 Six Sigma DMAIC process stability control"
...
```
research_query: "industrial AI organizational capability data science team skills gap training manufacturing digital talent McKinsey Rewired AI at scale 工厂 AI 人才结构 技能缺口"
...
```
research_query: "change management AI adoption manufacturing Kotter ADKAR governance sponsorship resistance stakeholder 变革管理 AI 推行 工厂管理层承诺"
